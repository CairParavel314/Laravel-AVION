                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm font-medium">
                            <div class="flex space-x-2">
                                ...
                                <a href="{{ route('lotes.edit', $lote) }}" class="text-green-600 hover:text-green-900">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('lotes.destroy', $lote) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-600 hover:text-red-900" onclick="return confirm('¿Está seguro de eliminar este lote?')">
