        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-start">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('granjas.edit', $granja) }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="text-center py-8">
                ...
                <a href="{{ route('lotes.create') }}" class="mt-4 inline-block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">
                    Crear primer lote
                </a>
            </div>
            @endif
